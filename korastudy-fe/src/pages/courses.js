...
const Courses = () => {
  ...
  const categories = [
    ...
    { id: 'topik1', name: 'TOPIK I', count: 8 },
    { id: 'topik2', name: 'TOPIK II', count: 10 },
    { id: 'grammar', name: 'Ngữ pháp', count: 6 },
    { id: 'vocabulary', name: 'Từ vựng', count: 4 },
    { id: 'speaking', name: 'Giao tiếp', count: 3 },
    { id: 'writing', name: 'Viết', count: 2 }
  ];
  ...
  const featuredCourses = [
    {
      ...
      description: "Khóa học dành cho người mới bắt đầu học tiếng Hàn, từ bảng chữ cái đến TOPIK I",
  ...
  const filteredCourses = allCourses.filter(course => {
    ...
    const matchesLevel = selectedLevel === 'all' || 
      ...
      (selectedLevel === 'all' && course.level === 'Tất cả');
